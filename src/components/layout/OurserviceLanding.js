  ...
  return (
    <section className="pt-[4rem] bg-[#F5F7FA] min-h-screen" id="serviceofferedpage">
      ...
      "
            ...
            {/* Note: Adjust the #093A70 hex color if your brand uses a different specific shade of blue */}
            <button className="ms-0 md:ms-[5%]  flex items-center justify-center gap-3 px-6 py-3 rounded-lg border border-[#093A70] text-[#093A70] font-medium hover:bg-[#093A70] hover:text-white transition-colors duration-300 whitespace-nowrap shrink-0">
              <Link
                href="/ourservice"
